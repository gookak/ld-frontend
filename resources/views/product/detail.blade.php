                            ...
                            <div class="product-images">
                                ...
                                <div class="product-main-img ace-thumbnails clearfix">
                                    <a href="{{ asset(env('FILE_URL').$product->productImage[0]->fileupload->filename )}}" data-rel="colorbox">
                                        <img style="margin: auto;" height="auto" width="300" class="img-responsive" src="{{ asset(env('FILE_URL').$product->productImage[0]->fileupload->filename )}}" />
                                    </a>
                                </div>
                                ...
                                <a href="{{ asset(env('FILE_URL')."noimage.jpg" )}}" data-rel="colorbox">
                                    <img height="auto" width="300" src="{{ asset(env('FILE_URL')."noimage.jpg" )}}">
                                </a>
                                @endif
                            </div>
                        </div>
